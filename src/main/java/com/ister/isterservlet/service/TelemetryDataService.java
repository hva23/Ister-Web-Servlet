...
import com.ister.isterservlet.repository.TelemetryDataRepository;

import java.util.List;
import java.util.Optional;

public class TelemetryDataService {
    TelemetryDataRepository telemetryDataRepository = new TelemetryDataRepository("jdbc:mysql://localhost:8080/Ister", "root", "v@h@bI2442");
