...
public class TelemetryDataRepository implements baseRepository<TelemetryData, Long> {
    final private String rawUrl;
    final private String username;
    final private String password;
    final private String TABLE_NAME = "TELEMETRY_DATA";

    public TelemetryDataRepository(String rawUrl, String username, String password) {
        this.rawUrl = rawUrl;
    ...
    public boolean create(TelemetryData telemetryData) {
        try {
            ...
            values = new Object[]{
                    ...
                    val,
                    dateTime,
                    telemetryData.getProduct().getId()
            };
    ...
    public Optional<TelemetryData> findById(Long id) {
        ...
        try {
            ...
            product.setId(resultSet.getLong("USER_PRODUCTS_ID"));
